...
fun yyAction0 (strm, lastMatch : yymatch) = (yystrm := strm;
      (lexComment := 1; YYBEGIN COMMENT; continue()))
...
fun yyAction43 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (Tokens.STRING(trim(yytext), yypos, yypos + String.size yytext))
      end
...
fun yyAction48 (strm, lastMatch : yymatch) = (yystrm := strm;
      (lexComment := !lexComment + 1; continue()))
fun yyAction49 (strm, lastMatch : yymatch) = (yystrm := strm;
      (if !lexComment = 1 then YYBEGIN INITIAL else (); lexComment := !lexComment + ~1; continue()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction44(strm, yyNO_MATCH)
                      else yyQ45(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ45(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ50(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ45(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
              else yyAction44(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ83(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ45(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
              else yyAction44(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ90(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"#"
              ...
              then if inp = #"\""
                  ...
                  else yyQ95(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"\\"
